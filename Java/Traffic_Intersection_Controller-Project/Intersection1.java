...
public class Intersection1 {
	public static void main(String[] args) {
		...
		OP1.SetName("OP1");
		OP1.Value = new TransferOperation("localhost", "1400", "in1");
		...
		OP2.SetName("OP2");
		OP2.Value = new TransferOperation("localhost", "1400", "in2");
		...
		OP3.SetName("OP3");
		OP3.Value = new TransferOperation("localhost", "1400", "in3");
		...
		PO3.SetName("PO3");
		PO3.Value = new TransferOperation("localhost", "1002", "p5");
		...
		System.out.println("Start: Intersection 1\n");
		pn.Delay = 2000;
